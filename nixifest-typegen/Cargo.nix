...
#   "generate" "--cargo-toml" "nixifest-typegen/Cargo.toml" "--output" "nixifest-typegen/Cargo.nix"
...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nixifest-typegen" = rec {
        crateName = "nixifest-typegen";
        version = "0.1.0";
        edition = "2024";
        crateBin = [
          {
            name = "nixifest-typegen";
            path = "src/main.rs";
            requiredFeatures = [ ];
          }
        ];
